    ...
    <main>
        <section class="px-2">
            <div class="pricing-header pb-3 pb-md-4 mx-auto text-center">
                ...
                <p class="fs-5 text-body-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed vel quam a sint aperiam quidem placeat ipsam facere repellendus. Delectus.</p>
            </div>
            <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
                ...
                <div class="card mb-4 rounded-3 shadow-sm border-success">
                        ...
                        <div class="card-body">
                            ...
                            <a type="button" href="index.php#now-showing" class="w-100 btn btn-lg btn-success">Book Tickets</a>
                        </div>
                    </div>
                </div>
                <div class="col">
